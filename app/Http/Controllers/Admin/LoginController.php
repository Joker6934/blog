...
//        2. 进行表单验证
        ...
        $msg = [
            ...
            'password.alpha_dash'=>'密码必须是字母，数字，下滑线',
        ];
...
//        3. crypt加密
        $str = '123456';//admin的密码
        $crypt_str = 'eyJpdiI6IjFRbTJUZFJoTWpiOHFFaWtud1FLN3c9PSIsInZhbHVlIjoiSXpMWDdEdE4rWnFBXC9YSldBenZYYUE9PSIsIm1hYyI6ImY0NDE4NDY0YmZkMWM0YTZhMzU0NmEwNjMzYzhhZGJmNTc5YTcwNDg5ZDJkYTA1ZThkOGE4Y2ZkMmZkNDY0ODMifQ';
